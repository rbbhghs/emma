- view: derived_workflow_state_duration
  derived_table:
    sql: |
      select e.event_type_id,e.event_id from_event_id,e.created,e.entity_id as treatment_cycle_referral_id,ws_from.name from_workstate,ws_to.name next_workstate,
      ...
      from event e 
      JOIN event e1 ON (e1.event_id > e.event_id and e1.entity_id = e.entity_id) 
      ...
      and e.event_id = 1 and e1.event_id = 1 
